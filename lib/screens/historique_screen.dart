                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Voitures', style: AppTextStyles.caption(color: isDark ? Colors.white60 : AppTheme.ink600)),
                              Text('7', style: AppTextStyles.dataLg(color: isDark ? Colors.white : AppTheme.ink900)),
                            ],
                          )
                        ],
                      ),
                      ...
                      child: Row(
                        children: [
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('CA Total', style: AppTextStyles.caption(color: isDark ? Colors.white60 : AppTheme.ink600)),
                              Text('1 540 DT', style: AppTextStyles.dataLg(color: isDark ? Colors.white : AppTheme.ink900).copyWith(fontSize: 16)),
                            ],
                          )
                        ],
                      ),
            ...
            Expanded(
              child: Center(
                child: Text(
                  ...
                  style: AppTextStyles.bodyLg(color: isDark ? Colors.white60 : AppTheme.ink400),
                ),
              ),
            ),
          ],
