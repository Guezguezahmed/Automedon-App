        ...
        appBar: AppBar(
          ...
          actions: [
            OutlinedButton(
              ...
              child: Text('Parc', style: AppTextStyles.bodyLg(color: isDark ? Colors.white : AppTheme.ink900)),
            ),
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(child: Text('Peugeot', style: AppTextStyles.displayMd(color: isDark ? Colors.white : AppTheme.ink900))),
                Text('2', style: AppTextStyles.dataLg(color: isDark ? Colors.white60 : AppTheme.ink600).copyWith(fontSize: 18)),
              ],
            ),
              ...
              child: Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('208 Active', style: AppTextStyles.bodyLg(color: isDark ? Colors.white : AppTheme.ink900)),
                      ...
                      Container(
                        ...
                        child: Text('112 TUN 4567', style: AppTextStyles.dataSm(color: isDark ? Colors.white60 : AppTheme.ink600)),
                      ),
                    ],
                  ),
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Icons.description_outlined, size: 14, color: isDark ? Colors.white60 : AppTheme.ink600),
                          const SizedBox(width: 4),
                          Text('4/4', style: AppTextStyles.dataSm(color: isDark ? Colors.white60 : AppTheme.ink600)),
                        ],
                      )
                    ],
                  ),
