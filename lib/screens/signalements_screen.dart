            ...
            children: [
              ...
              AppCard(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Signaler un Client', style: AppTextStyles.displayMd(color: isDark ? Colors.white : AppTheme.ink900)),
                    const SizedBox(height: AppTheme.sp6),
                    TextField(
                      style: TextStyle(color: isDark ? Colors.white : AppTheme.ink900),
                      decoration: InputDecoration(
                        hintText: 'Nom du client',
                        fillColor: isDark ? AppTheme.darkSurface : AppTheme.surfaceApp,
                        filled: true,
                      ),
                    ),
